...
const navigation: any[] = [
    ...
    { name: 'user portal', href: '/auth', current: false },
    { name: 'test', href: '/test', current: false },
  ]
  
//   function classNames(args) {
//     return args.split(" ").classes.filter(Boolean).join(' ')
//   }
  
  export function Header(): React.ReactNode {
    const navigate = useNavigate();
    return (
      <Disclosure as="nav" className="bg-slate-400 text-gray-900 dark:bg-gray-800 dark:text-gray-100">
